...
import program31 from '../assets/program31.jpeg';
import program32 from '../assets/program32.jpeg';
import program5 from '../assets/program5.jpeg';
import program51 from '../assets/program51.jpeg';
import program52 from '../assets/program52.jpeg';
import program6 from '../assets/program6.jpeg';
...
export const facilities = [
    ...
    {
        id: 2,
        images: [image10,image17],
        title: "Vocational Lab",
        text: "We understand the pivotal role technology plays in modern education. Our vocational lab facilities are designed to provide students with a cutting-edge learning environment that fosters digital literacy.",
    },
    {
        id: 3,
        images: [image11],
...
export const programs = [
    {
        ...
        text: "The Student Police Cadet (SPC) program promotes discipline, leadership, and civic responsibility among students through training in law, ethics, and community service.",
    },
    {
        id: 2,
        images: [program2],
        title: "Yoga",
        text: "Yoga is a practice that combines physical postures, breathing exercises, and meditation to improve flexibility, strength, and mental well-being. It promotes relaxation, reduces stress, and enhances overall health.",
    },
    {
        id: 3,
        images: [program3,program31,program32],
        title: "Tree Plantation Drive",
        text: "Encourages students to plant and care for trees, fostering environmental awareness, sustainability, and a sense of responsibility toward nature while improving air quality and biodiversity.",
    },
    {
        id: 5,
        images: [program5,program51,program52],
        title: "Industrial visits",
        text: "Industrial visits provide students with real-world exposure to industries, helping them understand practical applications of their studies. They offer insights into manufacturing processes, technology, and workplace environments, bridging the gap between theory and practice.",
    },
    {
        id: 6,
        images: [program6],
        title: "cycle distribution program",
        text: "The cycle distribution program helps students, especially those from rural areas, commute to school easily and safely. It promotes education, reduces travel time, and encourages eco-friendly transportation, fostering independence and responsibility.",
    },
];